          	...
          	<div class="row breadcrumbs-top">
            	<div class="breadcrumb-wrapper col-12">
      				<ol class="breadcrumb">
        				...
        				<li class="breadcrumb-item"><a href="#">Konsolidasi</a></li>
                        <li class="breadcrumb-item"><a href="#">Laporan Prognosis</a></li>
                		...
                		<div class="card-content">
                  			<div class="card-body">
                    			<div class="tab-content px-1 pt-1">
                      				<br />
	                               {!! Form::open(['id'=>'form-cetak', 'method'=>'POST', 'url'=>'konsolidasi/prognosis/lra-prognosis-permen', 'class'=>'form form-horizontal']) !!}
                      					<div class="form-body">
...
@section('javascript')
	<script type="text/javascript">
            socket.on("channel-name-konsolidasi:App\\Events\\Konsolidasi\\NotifikasiLaporanKonsolidasiPrognosisPermenEvent", function(message){
