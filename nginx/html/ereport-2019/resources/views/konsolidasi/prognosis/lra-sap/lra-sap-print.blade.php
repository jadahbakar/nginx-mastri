	...
	<body>
		...
		<table width="100%" class="table-border" cellpadding="2" cellspacing="2" style="table-layout: fixed; word-wrap: break-word;">
			...
			<tbody>
				...
				<tr>
					<td class="bottom-top"><center>19</center></td>
					<td class="bottom-top" style="padding-left: 30px;">Dana Penyesuaian</td>
					<td class="bottom-top" style="text-align: right;">0</td>
					<td class="bottom-top" style="text-align: right;">0</td>
					<td class="bottom-top" style="text-align: right;">0</td>
					<td class="bottom-top" style="text-align: right;">0</td>
				...
				@endphp
				<tr>
					<td class="top"><center><b>20</b></center></td>
					<td class="top"><b>Jumlah Pendapatan Transfer Pemerintah Pusat - Lainnya (18 s/d 19)</b></td>
					<td class="top" style="text-align: right;"><b>{{ mataUang($jumAnggaran20) }}</b></td>
					<td class="top" style="text-align: right;"><b>{{ mataUang($jumRealisasi20) }}</b></td>
					<td class="top" style="text-align: right;"><b>{{ mataUang($jumSisaAnggaran20) }}</b></td>
					<td class="top" style="text-align: right;"><b>{{ mataUang($jumPrognosis20) }}</b></td>
					<td class="top" style="text-align: right;"><b>{{ mataUang($jumTotalPrognosis20) }}</b></td>
				...
				@endphp
				<tr>
					<td class="bottom-top"><center>47</center></td>
					<td class="bottom-top" style="padding-left: 30px;">Belanja Peralatan dan Mesin</td>
					<td class="bottom-top" style="text-align: right;">{{ mataUang($anggaran) }}</td>
					<td class="bottom-top" style="text-align: right;">{{ mataUang($realisasi) }}</td>
					<td class="bottom-top" style="text-align: right;">{{ mataUang($sisaAnggaran) }}</td>
					<td class="bottom-top" style="text-align: right;">{{ mataUang($prognosis) }}</td>
				...
				@endphp
				<tr>
					<td class="top"><center>49</center></td>
					<td class="top" style="padding-left: 30px;">Belanja Jalan, Irigasi dan Jaringan</td>
				...
				@endphp
				<tr>
					<td class="bottom-top"><center>75</center></td>
					<td class="bottom-top" style="padding-left: 30px;">Hasil Penjualan Kekayaan Daerah yang Dipisahkan</td>
					<td class="bottom-top" style="text-align: right;">{{ mataUang($anggaran) }}</td>
					<td class="bottom-top" style="text-align: right;">{{ mataUang($realisasi) }}</td>
					<td class="bottom-top" style="text-align: right;">{{ mataUang($sisaAnggaran) }}</td>
					<td class="bottom-top" style="text-align: right;">{{ mataUang($prognosis) }}</td>
				...
				@endphp
				<tr>
					<td class="top"><center>78</center></td>
					<td class="top" style="padding-left: 30px;">Pinjaman Dalam Negeri - Lembaga Keuangan Bank</td>
					<td class="top" style="text-align: right;">{{ mataUang($anggaran) }}</td>
					<td class="top" style="text-align: right;">{{ mataUang($realisasi) }}</td>
					<td class="top" style="text-align: right;">{{ mataUang($sisaAnggaran) }}</td>
					<td class="top" style="text-align: right;">{{ mataUang($prognosis) }}</td>
				...
				@endphp
				<tr>
					<td class="bottom-top"><center>97</center></td>
					<td class="bottom-top" style="padding-left: 30px;">Pemberian Pinjaman kepada Perusahaan Daerah</td>
					<td class="bottom-top" style="text-align: right;">{{ mataUang($anggaran) }}</td>
					<td class="bottom-top" style="text-align: right;">{{ mataUang($realisasi) }}</td>
					<td class="bottom-top" style="text-align: right;">{{ mataUang($sisaAnggaran) }}</td>
					<td class="bottom-top" style="text-align: right;">{{ mataUang($prognosis) }}</td>
				...
				@endphp
				<tr>
					<td class="top"><center><b>100</b></center></td>
					<td class="top"><b>PEMBIAYAAN NETTO (85 - 99)</b></td>
					<td class="top" style="text-align: right;"><b>{{ mataUang($jumAnggaran100) }}</b></td>
					<td class="top" style="text-align: right;"><b>{{ mataUang($jumRealisasi100) }}</b></td>
					<td class="top" style="text-align: right;"><b>{{ mataUang($jumSisaAnggaran100) }}</b></td>
					<td class="top" style="text-align: right;"><b>{{ mataUang($jumPrognosis100) }}</b></td>
					<td class="top" style="text-align: right;"><b>{{ mataUang($jumTotalPrognosis100) }}</b></td>
					<td class="top" style="text-align: right;">&nbsp;</td>
				</tr>
				<tr>
		...
		<br/>
		@if($tandaTangan->status == 'Aktif')
			<table cellpadding="0" cellspacing="0">
				<tr>
					<td width="60%">&nbsp;</td>
					<td><center>Semarang, {{ tanggal_format_indonesia(\Carbon\Carbon::parse($tandaTangan->tanggal)->format('Y-m-d')) }}</center></td>
				</tr>
				<tr>
					<td width="60%">&nbsp;</td>
					<td><center>{{ $tandaTangan->pejabat_penanda_tangan_1 }}</center></td>
				</tr>
				<tr>
					<td width="60%">&nbsp;</td>
					<td><center>{{ $tandaTangan->pejabat_penanda_tangan_2 }}</center></td>
				</tr>
				<tr>
					<td height="60px" width="60%">&nbsp;</td>
					<td>&nbsp;</td>
				</tr>
				<tr>
					<td width="60%">&nbsp;</td>
					<td><center>{{ $tandaTangan->nama }}</center></td>
				</tr>
				<tr>
					<td width="60%">&nbsp;</td>
					<td><center>{{ $tandaTangan->nip }}</center></td>
				</tr>
				<tr>
					<td width="60%">&nbsp;</td>
					<td><center>{{ $tandaTangan->jabatan }}</center></td>
				</tr>
			</table>
		@endif

		<script type="text/php">
			$text = 'Dicetak pada {{ \Carbon\Carbon::now()->format('d-m-Y H:i:s') }}';
			$text .= '                                                                               ';
			$text .= '                                             Halaman: {PAGE_NUM} / {PAGE_COUNT}';
			$font= $fontMetrics->get_font("sans-serif", "italic");
			$pdf->page_text(37, 580, $text, $font, 8);
		</script>
	</body>
</html>
