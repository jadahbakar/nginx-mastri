                		...
                		<div class="card-content">
                  			<div class="card-body">
                    			<div class="tab-content px-1 pt-1">
                      				<br />
	                               {!! Form::open(['id'=>'form-cetak', 'method'=>'POST', 'url'=>'konsolidasi/prognosis/lra-prognosis-sap', 'class'=>'form form-horizontal']) !!}
                      					<div class="form-body">
...
@section('javascript')
	<script type="text/javascript">
            socket.on("channel-name-konsolidasi:App\\Events\\Konsolidasi\\NotifikasiLaporanKonsolidasiPrognosisSapEvent", function(message){
