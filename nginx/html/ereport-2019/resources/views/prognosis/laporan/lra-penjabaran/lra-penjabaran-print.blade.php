<html>
	...
	<body>
		...
		<h3 style="text-align:center;">PENJABARAN LAPORAN REALISASI SEMESTER I APBD DAN PROGNOSIS 6 (ENAM) BULAN BERIKUTNYA</h3>
		...
		<table border="0">
			...
			<tr>
				...
				<td class="font15" style="text-align: right;"><b>SKPD / PPKD</b></td>
			</tr>
		</table>
		@php
		...
		<table width="100%" class="table-border" cellpadding="2" cellspacing="2" style="table-layout: fixed; word-wrap: break-word;">
			<thead style="background-color: #cdcdcd; font-size: 13px;">
				<tr>
					<th height="50px" width="18%"><center><b>Kode Rekening</b></center></th>
			...
			<tbody>
				@php
					$listRekeningPendapatan = $helper->getListRekeningPendapatanPenjabaran($viewData, $kodePengguna, $kodeOrganisasi, $tahun);
				...
				@foreach($listRekeningPendapatan as $pendapatan)
					@php
						...
						if(strlen($pendapatan['kdRekening']) >= '35'){
				...
				@endif
				@php
					$listRekeningPengeluaran = $helper->getListRekeningPengeluaranPenjabaran($viewData, $kodePengguna, $kodeOrganisasi, $tahun);
					...
					$array_belanja_daerah_2= array('5 1','5 3');
				...
				@foreach($listRekeningPengeluaran as $pengeluaran)
					@php
						...
						if($kodeEksekusi == 1){
							...
							if(strlen($pengeluaran['kdRekening']) >= '35'){
				...
				@php
					$listRekeningPenerimaanPembiayaan = $helper->getListRekeningPenerimaanPembiayaanPenjabaran($viewData, $kodePengguna, $kodeOrganisasi, $tahun);
				...
				@foreach($listRekeningPenerimaanPembiayaan as $penerimaanPembiayaan)
					@php
						...
						if(strlen($penerimaanPembiayaan['kdRekening']) >= '35'){
				...
				@endif
				@php
					$listRekeningPengeluaranPembiayaan = $helper->getListRekeningPengeluaranPembiayaanPenjabaran($viewData, $kodePengguna, $kodeOrganisasi, $tahun);
				...
				@foreach($listRekeningPengeluaranPembiayaan as $pengeluaranPembiayaan)
					@php
						...
						if(strlen($pengeluaranPembiayaan['kdRekening']) >= '35'){
