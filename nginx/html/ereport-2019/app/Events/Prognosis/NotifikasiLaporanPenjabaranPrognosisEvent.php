...
class NotifikasiLaporanPenjabaranPrognosisEvent implements ShouldBroadcast
{
    ...
    {
        Log:info('Broadcast notifikasi event laporan penjabaran prognosis | channel-name-'.$dataEvent['inputBy']);
