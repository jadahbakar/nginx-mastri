...
class NotifikasiLaporanPrognosisSapEvent implements ShouldBroadcast
{
    ...
    {
        Log:info('Broadcast notifikasi event laporan prognosis sap | channel-name-'.$dataEvent['inputBy']);
