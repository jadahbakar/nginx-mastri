...
class NotifikasiLaporanKonsolidasiPrognosisSapEvent implements ShouldBroadcast
{
    ...
    {
        Log:info('Broadcast notifikasi event laporan konsolidasi prognosis sap | channel-name-konsolidasi');
