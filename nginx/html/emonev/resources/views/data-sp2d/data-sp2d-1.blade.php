...
<div class="row page-titles">
    <div class="col-md-5 col-8 align-self-center">
        <h3 class="text-themecolor">Data SP2D</h3>
        <ol class="breadcrumb">
            <li class="breadcrumb-item"><a href="javascript:void(0)">Beranda</a></li>
            <li class="breadcrumb-item active">Data SP2D</li>
        </ol>
    </div>
</div>
            ...
            <div class="card-body">
                ...
                <div class="tab-content">
                    <div class="tab-pane active">
                        ...
                        <div class="row">
                            <div class="col-md-3">
                                {!! Form::open(['id'=>'form-sp2d', 'method'=>'POST', 'route'=>'data-sp2d.store', 'class'=>'form-horizontal']) !!}
                            ...
                            <div class="col-md-12">
                                <div class="table-responsive">
                                    <table class="table color-table inverse-table table-hover" style="width: 2000px;">
                                        <thead>
                                            <tr>
                                                {{-- <th width="100px" style="text-align: center;"><b>Aksi</b></th> --}}
                                                <th style="text-align: center;"><b>Tahun Anggaran</b></th>
                                                <th style="text-align: center;"><b>Tgl SP2D</b></th>
                                                <th style="text-align: center;"><b>Jenis SP2D</b></th>
                                                ...
                                                <th style="text-align: center;"><b>Jumlah SP2D</b></th>
                                            </tr>
                                        </thead>
                                        <tbody>
                                            @php
                                            ...
                                            @foreach($listSp2d as $item)
                                                ...
                                                <tr>
                                                    ...
                                                    <td style="text-align: center;">{{ $item['tanggal_sp2d'] }}</td>
                                                    <td style="text-align: center;">{{ jenis($item['jenis_sp2d']) }}</td>
                                                    ...
                                                    <td style="text-align: right;">{{ $item['jumlah_sp2d'] }}</td>
                                                </tr>
                                            @endforeach
                                        </tbody>
                                    </table>
