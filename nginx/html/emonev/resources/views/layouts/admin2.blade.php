...
<body class="fix-header fix-sidebar card-no-border logo-center">
            ...
            <nav class="navbar top-navbar navbar-expand-md navbar-light">
                ...
                <div class="navbar-collapse">
                    ...
                    <ul class="navbar-nav my-lg-0">
                        ...
                        <!-- ============================================================== -->
                        <li class="nav-item dropdown">
                            <a class="nav-link dropdown-toggle text-muted waves-effect waves-dark" href="" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false"><img src="{{ asset('material/assets/images/users/1.jpg') }}" alt="user" class="profile-pic" /></a>
                            <div class="dropdown-menu dropdown-menu-right scale-up">
                                <ul class="dropdown-user">
                                    <li>
                                        <div class="dw-user-box">
                                            <div class="u-img"><img src="{{ asset('material/assets/images/users/1.jpg') }}" alt="user"></div>
                                            <div class="u-text">
                                                <h4>Steave Jobs</h4>
        ...
        <div class="page-wrapper">
            ...
            <div class="container-fluid">
                ...
                <div class="row">
                                ...
                                <div class="table-responsive m-t-20">
                                    <table class="table stylish-table">
                                        ...
                                        <tbody>
                                            ...
                                            <tr class="active">
                                                <td><span class="round"><img src="{{ asset('material/assets/images/users/2.jpg') }}" alt="user" width="50"></span></td>
                                                <td>
                    ...
                    <div class="col-lg-4">
                        <!-- Column -->
                        <div class="card"> <img class="" src="{{ asset('material/assets/images/background/profile-bg.jpg') }}" alt="Card image cap">
                        ...
                        <div class="card">
                            ...
                            <div class="comment-widgets">
                                ...
                                <div class="d-flex flex-row comment-row">
                                    <div class="p-2"><span class="round"><img src="{{ asset('material/assets/images/users/1.jpg') }}" alt="user" width="50"></span></div>
                                ...
                                <div class="d-flex flex-row comment-row active">
                                    <div class="p-2"><span class="round"><img src="{{ asset('material/assets/images/users/2.jpg') }}" alt="user" width="50"></span></div>
                                ...
                                <!-- Comment Row -->
                                <div class="d-flex flex-row comment-row">
                                    <div class="p-2"><span class="round"><img src="{{ asset('material/assets/images/users/3.jpg') }}" alt="user" width="50"></span></div>
                                    <div class="comment-text w-100">
                                ...
                                <!-- Comment Row -->
                                <div class="d-flex flex-row comment-row">
                                    <div class="p-2"><span class="round"><img src="{{ asset('material/assets/images/users/4.jpg') }}" alt="user" width="50"></span></div>
                                    <div class="comment-text w-100">
                                        <h5>James Anderson</h5>
                                        <p class="m-b-5">Lorem Ipsum is simply dummy text of the printing and type setting industry. Lorem Ipsum has beenorem Ipsum is simply dummy text of the printing and type setting industry..</p>
                                        <div class="comment-footer"> <span class="text-muted pull-right">April 14, 2016</span> <span class="label label-info">Pending</span> <span class="action-icons">
                                ...
                                <div class="to-do-widget m-t-20">
                                    ...
                                    <ul class="list-task todo-list list-group m-b-0" data-role="tasklist">
                                        <li class="list-group-item" data-role="task">
                                            ...
                                            <ul class="assignedto">
                                                <li><img src="{{ asset('material/assets/images/users/1.jpg') }}" alt="user" data-toggle="tooltip" data-placement="top" title="" data-original-title="Steave"></li>
                                                <li><img src="{{ asset('material/assets/images/users/2.jpg') }}" alt="user" data-toggle="tooltip" data-placement="top" title="" data-original-title="Jessica"></li>
                                                <li><img src="{{ asset('material/assets/images/users/3.jpg') }}" alt="user" data-toggle="tooltip" data-placement="top" title="" data-original-title="Priyanka"></li>
                                                <li><img src="{{ asset('material/assets/images/users/4.jpg') }}" alt="user" data-toggle="tooltip" data-placement="top" title="" data-original-title="Selina"></li>
                                            </ul>
                                        </li>
                                        <li class="list-group-item" data-role="task">
                                            <div class="checkbox checkbox-info">
                                        ...
                                        <li class="list-group-item" data-role="task">
                                            ...
                                            <ul class="assignedto">
                                                <li><img src="{{ asset('material/assets/images/users/1.jpg') }}" alt="user" data-toggle="tooltip" data-placement="top" title="" data-original-title="Assign to Steave"></li>
                                                <li><img src="{{ asset('material/assets/images/users/2.jpg') }}" alt="user" data-toggle="tooltip" data-placement="top" title="" data-original-title="Assign to Jessica"></li>
                                                <li><img src="{{ asset('material/assets/images/users/4.jpg') }}" alt="user" data-toggle="tooltip" data-placement="top" title="" data-original-title="Assign to Selina"></li>
                                            </ul>
                                        </li>
                                    </ul>
                                </div>
    ...
    <script src="{{ asset('material/design/js/dashboard2.js') }}"></script>
    <!-- ============================================================== -->
    <!-- Style switcher -->
    <!-- ============================================================== -->
